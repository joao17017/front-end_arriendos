...
const DepartamentosArrendadosUsuario = () => {
  ...
  const submitComentario = async () => {
    try {
      ...
      await axios.post('http://localhost:3000/comentarios/usuario-a-arrendador', {
  ...
  return (
    <div>
      ...
      >
        <ModalContainer>
          <h2>Comentar a {selectedDepartamento?.Arrendador?.nombres}</h2>
...
export default DepartamentosArrendadosUsuario;
